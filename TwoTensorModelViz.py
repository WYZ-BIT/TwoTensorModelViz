...
class TwoTensorModelViz:
  def __init__(self, parent):
    ...
    information, please refer to https://github.com/WYZ-BIT/TwoTensorModelViz.
    """
    parent.acknowledgementText = """
    This module was originally developed at SPL (http://www.spl.harvard.edu/)
    by Wenyao Zhang(School of Computer Science, Beijing Institute of Technology,
    China) and Lauren O'Donnell (Laboratory of Mathematics in Imaging at Harvard
    Medical School). It was partially funded by China Scholarship Council under
    the grant 201306035016.
    """ 
